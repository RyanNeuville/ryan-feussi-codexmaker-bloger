      ...
      <div>
        <form onSubmit={submitData}>
          ...
          <input
            ...
            type="text"
            value={title}
            className="input focus:outline-2 focus:outline-blue-500"
          />
          <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
              <textarea
                ...
                rows={8}
                value={content}
                className="textarea focus:outline-2 focus:outline-blue-500 block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
              ></textarea>
            </div>
          </div>
          ...
          <a
            className="back btn btn-error text-white"
            href="#"
            onClick={() => Router.push("/")}
          >
            Annuler
